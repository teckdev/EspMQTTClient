...
EspMQTTClient::EspMQTTClient(
    ...
    const char *mqttClientName) : EspMQTTClient(nullptr, mqttServerPort, mqttClientName) {
}
...
EspMQTTClient::EspMQTTClient(
    ...
    const uint16_t mqttServerPort,
    const char *mqttClientName) : EspMQTTClient(NULL, NULL, mqttServerIp, NULL, NULL, NULL, NULL, NULL, mqttClientName, mqttServerPort, false) {
}
...
EspMQTTClient::EspMQTTClient(
    ...
    const uint16_t mqttServerPort) : EspMQTTClient(wifiSsid, wifiPassword, mqttServerIp, NULL, NULL, NULL, NULL, NULL, mqttClientName, mqttServerPort, false)
...
EspMQTTClient::EspMQTTClient(
    ...
    const char *mqttClientName) : EspMQTTClient(NULL, NULL, mqttServerIp, mqttUsername, mqttPassword, NULL, NULL, NULL, mqttClientName, mqttServerPort, false) {
}
...
EspMQTTClient::EspMQTTClient(
    ...
    const char *mqttClientName,
    const uint16_t mqttServerPort,
    bool mqttSecure) : EspMQTTClient(NULL, NULL, mqttServerIp, mqttUsername, mqttPassword, NULL, NULL, NULL, mqttClientName, mqttServerPort, mqttSecure) {
}
...
EspMQTTClient::EspMQTTClient(
    ...
    const char *mqttClientName,
    const uint16_t mqttServerPort,
    bool mqttSecure) : EspMQTTClient(NULL, NULL, mqttServerIp, mqttUsername, mqttPassword, mqttRootCA, NULL, NULL, mqttClientName, mqttServerPort, mqttSecure) {
}
...
EspMQTTClient::EspMQTTClient(
    ...
    const char *mqttClientName,
    const uint16_t mqttServerPort,
    bool mqttSecure) : _wifiSsid(wifiSsid),
